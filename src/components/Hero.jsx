        ...
        <div className="swiper-slide bg-dark bg-image hero" aria-label="Hero section background">
          <div className="container h-100">
            <div className="row h-100 hero-text">
              <div
                className="d-flex flex-column justify-content-center align-items-center align-items-md-start hero-text hero-content"
              >
                <h3
                  className="merriweather fs-24 text-white animate__animated animate__slideInDown animate__delay-1s"
                  aria-label="10 Years of Medical Excellence"
                >
                ...
                >
                  Discover the difference exceptional healthcare makes with Clinic — an SEO-optimized medical website template.
                </p>
